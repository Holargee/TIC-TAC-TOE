...
else if(b1.innerText=="x"&&b2.innerText=="o"&& b9.innerText=="o"&& b7.innerText.length<1){b7.innerText="x"}
...
else if(b1.innerText=="x"&& b9.innerText=="o"&& b3.innerText=="x" && b7.innerText.length<1){b7.innerText="x"}

else if(b1.innerText=="x"&& b9.innerText=="o"&& b3.innerText.length<1){b3.innerText="x"}
...
else if(b1.innerText=="o"&&b2.innerText=="x"&& b9.innerText=="x"&& b7.innerText.length<1){b7.innerText="o"}

else if(b1.innerText=="o"&& b7.innerText=="x"&& b9.innerText.length<1){b9.innerText="o"}

else if(b1.innerText=="o"&& b9.innerText=="x"&& b3.innerText=="o"&& b7.innerText<1){b7.innerText="o"}

else if(b1.innerText=="o"&& b9.innerText=="x"&& b3.innerText<1){b3.innerText="o"}
